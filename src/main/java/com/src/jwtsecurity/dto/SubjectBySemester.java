...
public class SubjectBySemester implements Serializable {
	...
	public SubjectBySemester() {

	}

	public SubjectBySemester(BigInteger subjectId, String code, String title, String description, Integer units,
			Time startTime, Time endTime, String schedule, String instructor, String instructorSchoolId) {
